function showHome() {
    ...
    let html = `<div class="header">
        <div class="logo">
            <svg onclick="location.reload()" aria-label="Threads" class="x1ypdohk x13dflua x11xpdln xk4oym4 xus2keu"
        ...
        <div class="my-navbar">
            <div class="fun-home">
                <button onclick="getAllThread()"><i class="fa-solid fa-house"></i></button>
            </div>
            <div class="fun-search">
                <button onclick="showFormSearch()"><i class="fa-solid fa-magnifying-glass"></i></button>
            </div>
            <div class="fun-new">
    ...
    <div class="modal_follow" id="modal_follow">
        <div class="frame_follow" id="frame_follow">
            <div class="follow_top">
                <div class="follower" id="follower" onclick="getFollower(preProfile)">
                    <span class="title_follower">Người theo dõi</span>
                    <span class="count_follower" id="count_follower"></span>
                </div>
                <div class="following">
                    <span class="title_following" onclick="getFollowing(preProfile)">Đang theo dõi</span>
                    <span class="count_following" id="count_following"></span></div>
                <button class="follow-close" onclick="closeFollowModal()"><i class="fa-solid fa-x"></i></button>
            </div>
            <div class="follow_middle" id="follow_middle">
                
            </div>
        </div>
    </div>
        <div class="modal_reply" id="modal_reply">
        <div class="new_comment" id="new_comment">
            <div class="reply_title"><span>Thread trả lời</span></div>
            <div class="frame_reply" id="frame_reply">
                <div class="reply_top">
                    <div class="reply_topleft">
                        <img src="/elements/${currentUser.avatar}" alt="">
                    </div>
                    <div class="reply_topright">
                        <div class="reply_username"><span>${currentUser.username}</span></div>
                        <div class="reply_content"><p oninput="isInputCommentContent()" id="editComment" class="editable" contentEditable="true"></p>
                        </div>
                    </div>
                    <button class="reply-close" onclick="closeReplyModal()"><i class="fa-solid fa-x"></i></button>
                </div>
                <div class="reply_bottom">
                    <div class="reply_bottomleft">
                        <span>Người theo dõi bạn có thể trả lời</span></div>
                    <div class="reply_bottomright">
                        <button onclick="postComment()" id="postComment" disabled>Đăng</button>
                    </div>
                </div>
            </div>
        </div>
